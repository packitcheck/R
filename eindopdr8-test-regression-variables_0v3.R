...
plaats_ongeval_2006 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2006))  + geom_point(color="violet",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2006

##Jaar 2007
ongevallen_dh_2007 <- filter(ongevallen_dh_2006_2015, Jaar == "2007")
plaats_ongeval_2007 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2007))  + geom_point(color="magenta",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2007

##Jaar 2008
ongevallen_dh_2008 <- filter(ongevallen_dh_2006_2015, Jaar == "2008")
plaats_ongeval_2008 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2008))  + geom_point(color="purple",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2008

##Jaar 2009
ongevallen_dh_2009 <- filter(ongevallen_dh_2006_2015, Jaar == "2009")
plaats_ongeval_2009 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2009))  + geom_point(color="blue",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2009

##Jaar 2010
ongevallen_dh_2010 <- filter(ongevallen_dh_2006_2015, Jaar == "2010")
plaats_ongeval_2010 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2010))  + geom_point(color="red",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2010

##Jaar 2011
ongevallen_dh_2011 <- filter(ongevallen_dh_2006_2015, Jaar == "2011")
plaats_ongeval_2011 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2011))  + geom_point(color="brown",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2011

##Jaar 2012
ongevallen_dh_2012 <- filter(ongevallen_dh_2006_2015, Jaar == "2012")
plaats_ongeval_2012 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2012))  + geom_point(color="orange",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2012

##Jaar 2013
ongevallen_dh_2013 <- filter(ongevallen_dh_2006_2015, Jaar == "2013")
plaats_ongeval_2013 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2013))  + geom_point(color="black",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2013
...
plaats_ongeval_2014 <-  ggmap(map_dh, base_layer = ggplot(aes(y = Longitude, x = Latitude, size = Jaar), data = ongevallen_dh_2014))  + geom_point(color="green",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2014

##Jaar 2015
ongevallen_dh_2015 <- filter(ongevallen_dh_2006_2015, Jaar == "2015")
plaats_ongeval_2015 <-  ggmap(map_dh, base_layer = ggplot(aes(x = Longitude, y = Latitude, size = Jaar), data = ongevallen_dh_2015))  + geom_point(color="turquoise",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_2015
