...
plaats_ongeval_dh_2014 <-  ggmap(map_dh, base_layer = ggplot(aes(y = Longitude, x = Latitude, size = Jaar), data = ongevallen_dh_2014))  + geom_point(color="green",alpha=0.3) # %>%  + facet_wrap(~ Maand)
plaats_ongeval_dh_2014
